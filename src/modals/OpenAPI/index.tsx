  ...
  return (
    ...
    >
      <div className="max-h-[97vh] overflow-y-auto sm:w-full md:w-full">
        <div className="bg-white-A700 flex flex-col gap-2 items-center justify-end p-4 md:px-5 rounded-[10px] shadow-bs1 w-full">
          <Text
          ...
          <div className="flex flex-col gap-6 items-center justify-start w-full">
            ...
            <div className="flex flex-row gap-4 items-center justify-between rounded-md w-full">
              <Button
                className="common-pointer cursor-pointer font-medium min-w-[134px] text-center text-sm"
              ...
              <Button
                className="border border-blue-A700 border-solid cursor-pointer font-medium min-w-[134px] text-center text-sm"
                shape="round"
                color="blue_A700"
                size="lg"
              >
