            ...
            <header className="flex items-center justify-center w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-center w-full">
                <Input
                  ...
                  wrapClassName="border border-blue_gray-300 border-solid flex md:flex-1 md:mt-0 my-0.5 w-[46%] md:w-full"
                  suffix={
            ...
            >
              <div className="bg-white-A700 flex flex-col gap-3 items-center justify-start p-[11px] rounded-[12px] w-full">
                ...
                <div className="flex flex-col gap-[19px] items-start justify-start mb-2">
                  ...
                  <Text
                    className="sm:text-[20.4px] md:text-[22.4px] text-[24.4px] text-green-600"
                    size="txtLatoRegular244"
                  >
                    <span className="text-colors font-urbanist text-left font-semibold">
                      $10
                    </span>
                    <span className="text-colors1 font-lato text-left font-normal">
                      {" "}
                    </span>
                    <span className="md:text-[19.35px] sm:text-[17.35px] text-colors2 font-urbanist text-left text-[21.35px] font-medium line-through">
                      $13
                    </span>
                  </Text>
                </div>
