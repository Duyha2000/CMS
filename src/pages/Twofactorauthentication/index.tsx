  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-gilroy items-center justify-start mx-auto p-[297px] md:px-10 sm:px-5 w-full">
        <div className="bg-white-A700 flex flex-col items-center justify-start p-[50px] md:px-5 rounded-[12px] shadow-bs1 w-[65%] md:w-full">
          <Img
          ...
          />
          <Text
            className="mt-[15px] text-2xl md:text-[22px] text-blue-A700 sm:text-xl"
          ...
          >
            ...
            <span className="text-colors7 font-gilroy text-left font-bold">
              +91 01234567890
            </span>
          </Text>
          <div className="flex flex-row font-opensans gap-4 items-center justify-center mt-[29px] rounded-[3px] w-[73%] md:w-full">
            <Button
              className="!text-blue-200 border border-blue-A700 border-solid cursor-pointer font-semibold min-w-[40px] rounded-[3px] text-center text-lg"
              color="white_A700"
            >
              |
            </Button>
