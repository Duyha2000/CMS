        ...
        <div className="flex md:flex-col flex-row md:gap-10 gap-[83px] items-start justify-center max-w-[941px] mb-60 mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col font-lato items-center justify-start shadow-bs3 w-[35%] md:w-full">
            <div className="bg-white-A700 h-[241px] md:h-[381px] px-1.5 relative w-full">
              <div className="absolute bg-gray-100_01 flex flex-col h-full inset-y-[0] items-center justify-start my-auto right-[2%] w-[56%]">
                <Img
                        ...
                        <div className="absolute bg-white-A700 bottom-[0] flex flex-col inset-x-[0] items-center justify-end mx-auto rounded-bl-[0.99px] rounded-br-[0.99px] shadow-bs4 w-full">
                          <div className="flex flex-col items-start justify-start w-[89%] md:w-full">
                            ...
                            <div className="flex flex-row gap-[1.73px] items-start justify-start w-auto">
                              <Button
                                className="cursor-pointer flex items-center justify-center min-w-[5px] rounded-[0.5px]"
                                leftIcon={
                                  <Img
                              ...
                              <Button
                                className="cursor-pointer flex items-center justify-center min-w-[11px] rounded-[0.5px]"
                                leftIcon={
                                  <Img
                                    className="h-px my-px"
                        ...
                        <div className="flex flex-col items-start justify-start w-[89%] md:w-full">
                          ...
                          <div className="flex flex-row gap-[1.73px] items-start justify-start w-auto">
                            <List
                              ...
                              orientation="horizontal"
                            >
                              <div className="bg-gray-50_05 flex flex-col items-start justify-start px-[0.74px] py-[0.25px] rounded-[0.5px] w-auto">
              ...
              <div className="absolute bg-gray-100_01 bottom-[0] flex flex-col items-center justify-start left-[2%] rounded-tl-[4.82px] rounded-tr-[4.82px] shadow-bs5 w-3/5">
                <div className="flex flex-col gap-[13px] items-center justify-start w-full">
                  ...
                  >
                    <div className="flex flex-col items-start justify-start mb-[3px] w-[85%] md:w-full">
                      ...
                      <div className="bg-gray-100_01 flex flex-col items-start justify-start md:ml-[0] ml-[7px] mt-2.5 p-[3.18px] rounded-[1.59px] shadow-bs6 w-auto">
